...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ["Editorial"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/01-gluck.gif",
  },
  {
    slug: "mision-veleta",
    title: "Misión Veleta",
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/02-mision-veleta.gif",
    standalone: true,
    noHoverZoom: true,
  },
  {
    ...
    kind: "gallery",
    thumbnail: "/images/graphic-design/03-intercoop.png",
  },
  {
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/04-hedwig.gif",
  },
  {
    slug: "pogo-tv",
    title: "Pogo TV",
    ...
    tags: ["Branding"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/05-pogo-tv.png",
  },
  {
    ...
    tags: ["Branding", "Editorial"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/06-bienal-buenos-aires.png",
  },
  {
    ...
    tags: ["Branding"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/07-festival-muralistas.png",
  },
  {
    slug: "carl-jung",
    ...
    tags: ["Editorial"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/08-carl-jung.png",
  },
  {
    slug: "coco-rosie",
    title: "CocoRosie",
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/09-coco-rosie.png",
  },
  {
    ...
    tags: ["Branding"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/10-mecha.png",
  },
  {
    slug: "pavilion",
    ...
    tags: ["Branding"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/11-pavilion.png",
  },
  {
    slug: "racket",
    title: "Racket Club",
    ...
    tags: ["Branding", "UX/UI"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/12-racket.png",
  },
  {
    slug: "uno-en-uno",
    title: "Uno en Uno",
    ...
    tags: ["Branding", "UX/UI"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/13-uno-en-uno.png",
  },
  {
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/14-car-photography.png",
  },
  {
    slug: "wes-anderson",
    title: "Wes Anderson",
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/15-wes-anderson.png",
  },
  {
    slug: "pfizer",
    ...
    tags: ["Editorial"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/16-pfizer.png",
  },
  {
    slug: "wake-up-dance",
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/17-wake-up-dance.png",
    standalone: true,
  },
  {
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/18-white-blue.png",
    standalone: true,
  },
  {
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/19-pink-green.png",
    standalone: true,
  },
  {
    slug: "ecstatic-dance",
    ...
    tags: ["Collage"],
    kind: "gallery",
    thumbnail: "/images/graphic-design/20-ecstatic-dance.png",
    standalone: true,
  },
];
